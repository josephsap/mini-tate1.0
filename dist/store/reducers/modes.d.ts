...
export declare const setEdit: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<boolean, string>, setDrag: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<boolean, string>, setCornerDrag: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<boolean, string>;
